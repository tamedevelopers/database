...
class Migration{
    ...
    static private function initStatic() 
    {
        ...
        if ( ! defined('APP_ORM_DOT_ENV') ) {
            ...
            // we have access to global Constant APP_ORM_DOT_ENV
            self::$database = APP_ORM_DOT_ENV['path']['path'];
        }
    ...
    static public function create(?string $table_name)
    {
        ...
        // get directory
        $dummyPath = realpath(__DIR__) . "\\dummy.php";
        ...
        echo sprintf("Table `%s` has been created successfully", basename($fileName, '.php'));
    }
